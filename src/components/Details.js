    ...
    <div className="card">
      ...
      <div className="card-body">
        <div className="card-text" id="details">
          ...
          <p className="detail">
            Sun sets at: {new Date(weather.sys.sunset * 1000).getHours()}:
          ...
          <p className="detail">
            Temperature ranges in area from {weather.main.temp_min}{" "}
            &#8451; to {weather.main.temp_max} &#8451;
          </p>
          <p className="detail">
            Pressure: {weather.main.pressure} hPa or{" "}
            {Math.round(weather.main.pressure / 1000)} bar
          </p>
          <p className="detail">Humidity: {weather.main.humidity}%</p>
          <p className="detail">
            Windspeed: {weather.wind.speed * 3.6} k/m
          </p>
